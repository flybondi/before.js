...
declare module 'react-router-dom' {
  ...
  declare export type RouterHistory = {
    ...
    push(path: string | Location, state?: any): void,
    replace(path: string | Location, state?: any): void,
    go(n: number): void,
    goBack(): void,
    goForward(): void,
  ...
  ): ComponentType<$Diff<ElementConfig<$Supertype<WrappedComponent>>, ContextRouter>>;
