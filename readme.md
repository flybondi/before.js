...
[![CircleCI](https://circleci.com/gh/flybondi/before.js.svg?style=shield&circle-token=4ba6f16c2f14514e0b638a89142b5056cf1aa9a9)](https://circleci.com/gh/flybondi/before.js)
...
3. Setup `ChunkExtractor` server-side, pass the _loadable-stats.json_ (file generated by webpack lodable plugin) path to the Before.js render method.

```js
import { render } from '@flybondi/before.js';
// ...

const loadableStatsPath = '../dist/loadable-stats.json';
